...
NGraphics = {
	...
	PROVINCE_NAME_DRAW_DISTANCE = 500.00, 			-- Remove province names beyond this distance
	...
	VICTORY_POINT_MAP_ICON_AFTER = {0, 20}, -- VP levels dependent. After this amount of VP the map icon becomes bigger dot.
	VICTORY_POINT_MAP_ICON_TEXT_CUTOFF = {100, 250, 900},  -- 200, 500, 1000 --At what camera distance the VP name text disappears.
	VICTORY_POINTS_DISTANCE_CUTOFF = {125, 325, 725}, -- At what distance VPs are hidden
